...
?>
	...
	<p>Are you sure you want to activate <strong class="orange"><? printCrewName($pendingArray['crewid'], 'rank', 'noLink');?></strong>? Once activated, the player will be able to login to SMS and participate in the game.</p>
