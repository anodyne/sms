...
?>
	...
	<h2>Delete Non-Playing Character?</h2>
	<p>Are you sure you want to delete the NPC <strong class="orange"><? printCrewName($pendingArray['crewid'], 'rank', 'noLink');?></strong>? This action cannot be undone!</p>
