...
(function($) {
  ...
  $.extend($.facebox, {
    settings: {
      opacity      : 0.85,
      overlay      : true,
      loadingImage : 'images/hud_loading.gif',
      closeImage   : 'images/hud_close.png',
  ...
  <div id="facebox" style="display:none;"> \
    <div class="popup"> \
      <div class="hud_body"> \
        <div class="hud_title"> \
			...
			SIMM Management System</div> \
        <div class="content_hud" style="padding:10px;"></div> \
      </div> \
    </div> \
  </div>'
  },
    ...
    reveal: function(data, klass) {
      ...
      $('#facebox .hud_body').children().fadeIn('normal')
